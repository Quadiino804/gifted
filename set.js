...
module.exports = {
SESSION_ID: process.env.SESSION_ID || "Gifted~KjwgEKiR#cXHyU0RJAZx-sApMjYdC2X-DbROCvUeb03qIXOecQcQ", // Add sess Id here espwcially when deploying on panels else use app.json and .env file...
